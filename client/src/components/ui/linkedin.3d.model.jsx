...
import cardGLB from "../../assets/models/linkedinCard.glb";
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false, playSignal = 0 }) {
  ...
  // Harden filtering and transparency to remove white edge
  if (texture) {
